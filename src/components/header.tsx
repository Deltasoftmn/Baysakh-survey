  ...
  return (
    ...
    >
      <Container className="flex h-16 items-center justify-between">
        ...
        >
          ...
          <div className="leading-tight">
            <div className={cn("text-sm font-semibold tracking-wide", scrolled ? "text-slate-900" : "text-white")}>
              {copy.brand.name}
            </div>
            <div className={cn("text-[11px] tracking-wide", scrolled ? "text-slate-600" : "text-white/70")}>
              {copy.brand.tagline}
            </div>
          </div>
        </Link>
      ...
      >
        ...
        <div
          className={cn(
            "fixed right-0 top-0 h-full w-[min(92vw,420px)] bg-white shadow-2xl transition",
        ...
        >
          <div className="flex h-16 items-center justify-between gap-3 px-5">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0 text-sm font-semibold tracking-wide">
                {copy.brand.legal}
              </div>
            </div>
            <button
